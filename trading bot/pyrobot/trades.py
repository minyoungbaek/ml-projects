...
class Trade():
    ...
    def new_trade(self, trade_id: str, order_type: str, long_or_short: str, enter_or_exit: str, price: float = 0.00, stop_limit_price: float = 0.00) -> dict:
        ...
        elif self.order['orderType'] == 'TRAILING_LIMIT':
